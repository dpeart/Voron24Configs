...
mainsail_config_folder=~/mainsail_config

belay_klippy_module_folder=~/belay_klippy_module

Happy-Hare_folder=~/Happy-Hare

kiauh_folder=~/kiauh

kiauh-backups_folder=~/kiauh-backups

klippain_config_folder=~/klippain_config

klippain_shaketune_folder=~/klippain_shaketun
